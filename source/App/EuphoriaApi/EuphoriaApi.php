...
namespace Source\App\EuphoriaApi;

use Source\Core\Controller;
use Source\Models\Auth;
use Source\Models\EuphoriaApp\AppInvoice;
use Source\Models\EuphoriaApp\AppWallet;

/**
 * Class EuphoriaApi
 * @package Source\App\EuphoriaApi
 */
class EuphoriaApi extends Controller
{
    ...
    public function __construct()
    {
        ...
        $request = $this->requestLimit("euphoriaApi", 1, 1);
        if (!$request) {
            exit;
        }
     ...
     * @return EuphoriaApi
     */
    protected function call(int $code, string $type = null, string $message = null, string $rule = "errors"): EuphoriaApi
    {
     ...
     * @return EuphoriaApi
     */
    protected function back(array $response = null): EuphoriaApi
    {
        if (!empty($response)) {
