            ...
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search layout-spacing align-self-center">
                <form class="form-inline my-2 my-lg-0">
                    <div class="">
                        ...
                        <input type="text" class="form-control product-search" id="input-search" placeholder="Pesquisar Usuários...">
                    </div>
                </form>
            </div>
                    ...
                    <div class="item-content">
                        <div class="user-profile">
                            ...
                            <div class="user-meta-info">
                                <p class="user-name" data-name="<?= $user->fullName(); ?>"><?= $user->fullName(); ?></p>
                                <p class="user-work" data-occupation="<?= $user->roles_id; ?>"><?= $user->findRole(); ?></p>
                            </div>
                        </div>
                        <div class="user-email">
                        ...
                        <div class="user-phone">
                            <p class="info-title">Celular: </p>
                            <p class="usr-ph-no" data-phone="<?= $user->cellphone; ?>"><?= formatPhone($user->cellphone); ?></p>
                        </div>
                        <div class="action-btn">
                            <a href="<?= url('admin/config/user/'.$user->id);?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 edit"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                            </a>
                            <a href="#" data-post="<?= url("admin/config/user/{$user->id}"); ?>"
                               data-action="delete"
                               data-confirm-ok ="Sim"
