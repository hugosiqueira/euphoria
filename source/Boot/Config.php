...
define("CONF_MAIL_USER", "wide@euphoriamg.com.br");
define("CONF_MAIL_PASS", "6VQzRfHNGSsCUvYW");
define("CONF_MAIL_SENDER", ["name" => "Euphoria Formaturas", "address" => "wide@euphoriamg.com.br"]);
